...
public class UploadGstRulesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfStorageReference = FirebaseStorage.getInstance().getReference().child("pdfRules");
        pdfDatabaseReference = FirebaseDatabase.getInstance().getReference("pdfRules");
            ...
            fileReference.putFile(pdfUri)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(UploadGstRulesActivity.this, "Upload failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
    ...
    private void savePdfReferenceToDatabase(String pdfUrl) {
        ...
        Toast.makeText(UploadGstRulesActivity.this, "PDF uploaded successfully", Toast.LENGTH_SHORT).show();
    }
}
